    ...
    \textbf{[UC9] - Recommendation process}
        ...
        \begin{center}
            \begin{longtable}{|l|p{0.75\linewidth}|}
                ...
                \hline
                \textbf{Entry Condition}
                & New feedbacks are collected. \\ %AGGIUNGI QUESTA PARTE AL SEQUENCE
                \hline
                \textbf{Event Flow}
                & 1 - Recommendation System asks for students and companies feedback. \\ 
                & 2 - S\&C returns the feedback. \\
                & 3 - Recommendation System searches for possible matches between a student and an internship. \\
                & 4 - If a match is found the recommendation system asks for company and student information. \\
                \hline
                \textbf{Exit Condition}
                & Recommendation notifies about the match it found both the company and the student. \\
                \hline
                \textbf{Exception}
                & No exception. \\
                \hline
    ...
    \textbf{[UC10] - Submit application}
        ...
        \begin{center}
            \begin{longtable}{|l|p{0.75\linewidth}|}
                ...
                \hline
                \textbf{Entry Condition}
                & Student finds an internship he wants to apply to \\ %AGGIUNGI QUESTA PARTE AL SEQUENCE
                \hline
                \textbf{Event Flow}
                & 1 - Student asks for internship details. \\ 
    ...
    \textbf{[UC11] - Assess application}
        ...
        \begin{center}
            \begin{longtable}{|l|p{0.75\linewidth}|}
                ...
                \hline
                \textbf{Entry Condition}
                & Company receives an application from a student. \\ %AGGIUNGI QUESTA PARTE AL SEQUENCE
                \hline
                \textbf{Event Flow}
...
\subsubsection{Requirement Mapping}
    ...
    \begin{center}
        \begin{table}[H]
            \begin{tabular}{|l|l|}
                \textbf{[G1]} The platform should facilitate the matchmaking process between university students and companies offering internships.\\
                \hline
                ciao & ciao \\
                \hline
            \end{tabular}
