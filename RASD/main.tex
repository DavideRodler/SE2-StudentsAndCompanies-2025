...
A student who is seeking internship opportunities starts by preparing a CV that outlines their skills, experiences, and educational background. If the CV is not already prepared, the student creates one specifically for this purpose. After ensuring the CV is complete and accurate, the student logs into the S\&C platform and uploads the document via the dedicated section. Once uploaded, the CV becomes available for companies to review, increasing the student’s visibility to potential employers. %RIVEDERE SEQUENCE DIAGRAM
...
\begin{figure}[H]
    ...
    \caption{\textbf{Student Dashboard:} Provides students with access to settings and navigation options.}
...
\subsection{Functional Requirements \& Goals - Requirement mapping}
    ...
    \begin{center}
        \begin{longtable}{|l|p{0.75\linewidth}|}
            \hline
            \multicolumn{2}{|p{\linewidth}|}{\textbf{[G1] - The platform should facilitate the matchmaking process between university students and companies offering internships.}} \\
            \hline
...
\subsubsection{Use Cases and Sequence Diagrams}
    ...
    \textbf{[UC9] - Notify student about recommended internship}
        ...
        \begin{figure}[H]
            ...
            \caption{Notify student about recommended internship}
    ...
    \textbf{[UC10] - Notify company about recommended student} %FORSE VANNO INVERTITE UC10 E UC9
        ...
        \begin{figure}[H]
            ...
            \caption{Notify company about recommended students}
...
%Da togliere appena finito di rifare requirements
\subsubsection{Requirement Mapping}
    ...
    \begin{center}
        \begin{longtable}{|p{0.5\linewidth}|p{0.5\linewidth}|}
            ...
            \hline
                \begin{itemize}
                    \item [R3] - The system permits students to upload their CVs.
                    \item [R4] - The system permits students to modify their CVs.
                    \item [R6] - The system permits companies to publish their internship proposal.
                    \item [R7] - The system permits companies to modify their internship proposal.
                    \item [R9] - The system shows students only the internship proposals.
                    \item [R10] -The system shows companies only students CVs.
                    \item [R11] - If a student with a CV which is compatible with the company requests is available then the system notify the company about this student.
                    \item [R12] - If an internship which matches the interests of the student is available then the system notifies the student about this internship.
                    \item [R15] - If the user is interested, the system permits him to accept the recommendation.
                    \item [R16] - If both the company and the student accept the recommendation, the system puts them in contact.
                    \item [R17] - If the company and the student have been put in contact then the system starts the selection process.
                    \item [R18] - The system helps the company managing the interview.
                    \item [R19] - If the interview went well (the company is satisfied with the answers provided by the student), the system finalize the selection.
                    \item [R20] - The system collects the feedback from the users.
                    \item [R21] - The system uses collected feedback to feed statistical analysis applied during recommendation.
                \end{itemize}
             &  \\
            \hline
        \end{longtable}
